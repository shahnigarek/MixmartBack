...
{
    public partial class CreatedTermandConditionsTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title4 = table.Column<string>(maxLength: 255, nullable: true),
                    Title5 = table.Column<string>(maxLength: 255, nullable: true),
                    Title6 = table.Column<string>(maxLength: 255, nullable: true),
